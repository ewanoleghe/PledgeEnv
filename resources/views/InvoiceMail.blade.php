...
<p>Thank you for your order! Attached is your invoice. We’re thrilled to have you on board. To get the most out of {{ $data['service'] }}, do this primary next step:</p>
...
<p>
    Inspection Date: {{ \Carbon\Carbon::parse($data['selectedDate'])->format('M d, Y') }}<br>
