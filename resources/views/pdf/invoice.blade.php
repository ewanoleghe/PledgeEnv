...
<head>
    ...
    <style>
        ...
        .status-badge {
            background-color: #ffcc00; /* Yellow background for unpaid status */
...
<div class="container">
    ...
    <table style="width: 100%; border-collapse: collapse;">
        <tr>
            <td style="width: 70%; vertical-align: top; border: none;"> <!-- Left Column -->
                <h3 class="bold">Property Address</h3>
            ...
            <td style="width: 30%; text-align: right; border: none;"> <!-- Right Column -->
                <span class="status-badge">Status: Unpaid</span>
            </td>
        </tr>
    </table>
    ...
    <table class="table">
        ...
        <tbody>
            ...
            <tr>
                ...
                <td>{{ $data['InspectionType'] === 'reInspection' ? "Re-Inspection ({$data['orderNumber']})" : 'New Inspection' }}</td>
                <td></td>
            </tr>
            <tr>
            ...
            <tr>
                ...
                <td>{{ \Carbon\Carbon::parse($data['selectedDate'])->format('M d, Y') }}</td>
                {{-- <td>Mar 15, 2025</td> --}}
                <td></td>
            </tr>
            <tr>
            ...
            @if (!empty($data['optionalMessage']))
                <tr>
                    <td class="bold">Optional Message:</td>
                    <td>{{ \Illuminate\Support\Str::limit($data['optionalMessage'], 10) }}</td>
                    <td></td>
                </tr>
            @endif
    ...
    <div class="footer">
        ...
        <hr>
        {{-- 
        <p>For inquiries, contact us at {{ $data['contactEmail'] }}</p> 
        --}}
